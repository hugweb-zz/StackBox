...
class VerticalSnapController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItems = [UIBarButtonItem(title: "Delete", style: .plain, target: self, action: #selector(VerticalSnapController.randomRemove)),
                                                   UIBarButtonItem(barButtonSystemItem: .fixedSpace, target: self, action: nil),
                                                   UIBarButtonItem(title: "Reset", style: .plain, target: self, action: #selector(VerticalSnapController.reset))]
